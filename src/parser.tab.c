...
{
       0,    79,    79,    91,    99,   105,   106,   111,   120,   128,
     129,   130,   135,   136,   137,   142,   143,   144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "INT", "PRINT", "ASSIGN", "SEMICOLON", "LPAREN", "RPAREN", "PLUS",
  "MINUS", "STAR", "SLASH", "$accept", "program", "stmt_list", "stmt",
  "decl_stmt", "print_stmt", "expr", "term", "factor", YY_NULLPTR
};
...
{
      10,    15,    -6,    22,    10,   -11,   -11,   -11,    16,    -3,
     -11,   -11,    -3,   -11,   -11,    -3,    -1,     4,   -11,    -4,
       2,    18,    -3,    -3,    -3,    -3,   -11,   -11,   -11,     4,
       4,   -11,   -11
};
...
{
       0,     0,     0,     0,     2,     4,     5,     6,     0,     0,
       1,     3,     0,    15,    16,     0,     0,    11,    14,     0,
       0,     0,     0,     0,     0,     0,     7,    17,     8,     9,
      10,    12,    13
};
...
{
     -11,   -11,   -11,    23,   -11,   -11,   -10,    -2,     0
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     3,     4,     5,     6,     7,    16,    17,    18
};
...
{
      13,    14,    19,     9,    26,    20,    15,    22,    23,    21,
      22,    23,    27,    22,    23,     1,     2,    24,    25,     8,
      29,    30,    10,    12,    31,    32,    28,    11
};

static const yytype_int8 yycheck[] =
{
       3,     4,    12,     9,     8,    15,     9,    11,    12,    10,
      11,    12,    10,    11,    12,     5,     6,    13,    14,     4,
      22,    23,     0,     7,    24,    25,     8,     4
};
...
{
       0,     5,     6,    16,    17,    18,    19,    20,     4,     9,
       0,    18,     7,     3,     4,     9,    21,    22,    23,    21,
      21,    10,    11,    12,    13,    14,     8,    10,     8,    22,
      22,    23,    23
};
...
#line 1142 "parser.tab.c"
  ...
  case 7: /* decl_stmt: INT IDENTIFIER ASSIGN expr SEMICOLON  */
#line 112 "parser.y"
        {
            (yyval.node) = create_decl_node((yyvsp[-3].str), (yyvsp[-1].node));
            free((yyvsp[-3].str));          /* strdup'd by lexer */
        }
#line 1151 "parser.tab.c"
    break;

  case 8: /* print_stmt: PRINT LPAREN expr RPAREN SEMICOLON  */
#line 121 "parser.y"
        {
...
#line 1177 "parser.tab.c"
  ...
  case 12: /* term: term STAR factor  */
#line 135 "parser.y"
                        { (yyval.node) = create_binop_node('*', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1183 "parser.tab.c"
    break;

  case 13: /* term: term SLASH factor  */
#line 136 "parser.y"
                        { (yyval.node) = create_binop_node('/', (yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 143 "parser.y"
                                 { (yyval.node) = create_var_node((yyvsp[0].str)); free((yyvsp[0].str)); }
